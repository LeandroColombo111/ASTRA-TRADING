...
- **Entradas post-only (maker)**: las entradas se mandan como orden post-only apoyada en la mejor punta del libro en vez de cruzar el spread, para capturar la mejora de costo que el research mide entre ejecución maker y taker. Como una post-only puede quedar viva esperando precio, el servicio espera un tiempo acotado y la cancela si no se llenó — así la reconciliación de órdenes (que trata cualquier orden "viva" tras un intento de envío como una emergencia que requiere revisión manual) no cambia en nada. Los cierres y el stop/target siguen siendo órdenes de mercado, con ejecución garantizada.
